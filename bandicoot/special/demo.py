...
def export_antennas(user, directory, fid=""):
    with open(os.path.join(directory, fid + 'antenna.csv'), 'wb') as f:
...
def export_transitions(user, directory, fid=""):
    ...
    with open(os.path.join(directory, fid + 'transitions.csv'), 'wb') as f:
...
def export_timeline(user, directory, fid=""):
    with open(os.path.join(directory, fid + 'timeseries.csv'), 'wb') as f:
...
def export_network(user, directory, fid=""):
    ...
    with open(os.path.join(directory, fid + 'nodes.csv'), 'wb') as f:
    ...
    with open(os.path.join(directory, fid + 'links.csv'), 'wb') as f:
